...
function noderoll(obj,num){
	...
	var btnl=$(".btnl",obj)[0];
	var btnr=$(".btnr",obj)[0];
	var mw=parseInt(getstyle($("div",center)[0],"width"))+parseInt(getstyle($("div",center)[0],"marginRight"))+"px";
    var move=function(){
		if(flag){
			flag=false;
		    animate(center,{left:-parseInt(mw)*num},function(){
			var div=selectnodes(center)[0];
